package com.labIv.backend_elBuenSabor;

import com.labIv.backend_elBuenSabor.entities.*;
import com.labIv.backend_elBuenSabor.repositories.*;
...
public class BackendElBuenSaborApplication {


	private static final Logger logger = LoggerFactory.getLogger(BackendElBuenSaborApplication.class);
	...
	@Autowired
	private PedidoVentaRepository detallePedidoVentaRepository;
...
/*
	...
	CommandLineRunner init() {
		return args -> {
			...
			imagenArticuloRepository.save(imagenQueso);
			imagenArticuloRepository.save(imagenTomate);
			...
			imagenArticuloRepository.save(imagenPromocionEnamorados);
			...
			imagenArticuloRepository.save(imagenUsuario);
